# https://www.jianshu.com/p/3d1d480e61f0
...
file_path = 'E:\\test-password.rar'
file_path = 'E:\\BaiduNetdiskDownload\\生活DBZ-02\\生活DBZ-02\\SE02.rar'
output_path = '../rar'

# 密码范围
words = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.!@#$%^&*()_-+='  # 涉及到生成密码的参数
# words = '123456'
import sys

# pwds = get_password(5, 8, words)
pwds = get_password(int(sys.argv[1]), int(sys.argv[2]), words)
# 开始查找密码
start = time.time()
while True:
    pwd = next(pwds)
